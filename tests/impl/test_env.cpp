 ...
 * ---------------------
 *
 * This group of tests check the behavior of utilities defined in @ref kokkos-execution/impl/env.hpp.
 *
...
TEST(upsert, set_prop_in_empty_env) {
    constexpr auto new_env = Kokkos::Execution::Impl::upsert_in_env(prop_a, stdexec::env<>{}, 42);
...
TEST(upsert, replace_prop_in_single_prop) {
    static_assert([]() {
        ...
        auto new_env = Kokkos::Execution::Impl::upsert_in_env(prop_a, env, 42.);

        auto value = prop_a(new_env);

        static_assert(std::same_as<decltype(new_env), stdexec::prop<Tests::Impl::PropA, double>>);
...
TEST(upsert, replace_prop_in_env_with_single_prop) {
    static_assert([]() {
        ...
        static_assert(std::same_as<decltype(new_env), stdexec::env<stdexec::prop<Tests::Impl::PropA, double>>>);
...
TEST(upsert, add_prop_to_another_prop) {
    static_assert([]() {
        ...
        static_assert(std::same_as<
                      decltype(new_env),
                      stdexec::env<stdexec::prop<Tests::Impl::PropA, double>, stdexec::prop<Tests::Impl::PropB, int>>
        >);
...
TEST(upsert, replace_prop_in_env_with_two_props) {
    static_assert([]() {
        ...
        static_assert(std::same_as<
                      decltype(new_env),
                      stdexec::env<stdexec::prop<Tests::Impl::PropB, int>, stdexec::prop<Tests::Impl::PropA, double>>
        >);
...
TEST(upsert, replace_prop_in_forwarding_env_with_two_props) {
    static_assert([]() {
        ...
        auto new_env = Kokkos::Execution::Impl::upsert_in_env(fwd_prop_c, env, 42.);

        static_assert(
            std::same_as<
                decltype(new_env),
                stdexec::__env::__fwd<
                    stdexec::env<stdexec::prop<Tests::Impl::FwdPropD, int>, stdexec::prop<Tests::Impl::FwdPropC, double>>
                >
            >);
    ...
    static_assert([]() {
        ...
        static_assert(
            std::same_as<
                decltype(new_env),
                stdexec::env<
                    stdexec::prop<Tests::Impl::PropA, double>,
                    stdexec::env<stdexec::prop<Tests::Impl::PropB, int>, stdexec::prop<Tests::Impl::FwdPropC, int>>
                >
            >);
...
TEST(upsert, add_fwd_prop_to_forwarding_env) {
    static_assert([]() {
        ...
        static_assert(std::same_as<
                      decltype(new_env),
                      stdexec::env<
                          stdexec::prop<Tests::Impl::FwdPropC, double>,
                          stdexec::__env::__fwd<stdexec::env<stdexec::prop<Tests::Impl::FwdPropD, int>>>
                      >
        >);
...
TEST(upsert, upsert_with_move_only) {
    static_assert([]() {
        ...
        auto new_env = Kokkos::Execution::Impl::upsert_in_env(prop_b, env, MoveOnly(42));

        static_assert(std::same_as<
                      decltype(new_env),
                      stdexec::env<stdexec::prop<Tests::Impl::PropB, MoveOnly>, stdexec::prop<Tests::Impl::PropA, int>>
        >);
...
TEST(upsert, chain_multiple_upserts) {
    static_assert([]() {
        ...
        auto new_env = Kokkos::Execution::Impl::upsert_in_env(
            prop_a,
            Kokkos::Execution::Impl::upsert_in_env(prop_a, Kokkos::Execution::Impl::upsert_in_env(prop_a, env, 2.), 3.),
            4.);
...
TEST(upsert, ref_join_upsert) {
    ...
    const auto env_ref_join_upsert = Kokkos::Execution::Impl::upsert_in_env(prop_b, env_ref_join, 3.);

    static_assert(std::same_as<
                  decltype(env_ref_join),
                  stdexec::env<
                      stdexec::prop<Tests::Impl::PropB, int>,
                      stdexec::__env::__fwd<stdexec::prop<Tests::Impl::FwdPropC, double &> &>
                  >
    >);
    ...
    static_assert(std::same_as<
                  ...
                  stdexec::env<
                      stdexec::prop<Tests::Impl::PropB, double>,
                      stdexec::__env::__fwd<stdexec::prop<Tests::Impl::FwdPropC, double &> &>
                  >
    >);
